...
namespace Main.Resources.ROMToolboxDB {
    public class ToolboxDB {
        ...
        internal class BDHCAMPatchData {
            ...
            internal BDHCAMPatchData() {
                ...
                subroutine = (byte[])new ResourceManager("Main.Resources.ROMToolboxDB.BDHCAMPatchDB", Assembly.GetExecutingAssembly()).GetObject(RomInfo.romID + "_cam");
            }
        }
